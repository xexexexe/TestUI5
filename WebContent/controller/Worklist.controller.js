...
sap.ui.define([
...
], function (BaseController, JSONModel, formatter, FlaggedType, Filter, FilterOperator,Fragment,Dialog,Button) {
	"use strict";
	...
	return BaseController.extend("sap.ui.demo.bulletinboard.controller.Worklist", {
		...
		/**
		 * Click Pay button to generate  QR Code
		 */
		onShowBill: function () {
			var oDialog = new sap.m.Dialog("Dialog1",{
                ...
                content:[
                      new sap.ui.xmlfragment({
                    	  fragmentName:"sap.ui.demo.bulletinboard.view.QuickView",
                      })
